...
def main():
    ...
    output = open('../source_datasets/BCB/BCBcsv_onlyid/rand/all/short_test.csv', 'a')

    with open("../source_datasets/BCB/BCBcsv_onlyid/rand/all/test_all.csv") as f1:
        for line in f1:
            line_num = 0  # 当前行满足要求的代码数
