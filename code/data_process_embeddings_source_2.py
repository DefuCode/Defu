...
def main():
    ...
    output = open('datasets/BCB/preprocess/path_embeddings_graph_source_400.pkl', 'wb')
    # output = open('datasets/GCJ/preprocess/path_embeddings_source_400.pkl', 'wb')
    path_dict = {}
    state_dict = {}
    num_id = 0
    sum_ratio = 0
    ...
    for file in file_list:
        ...
        all_seq_ids = []
        pre_code = ' '.join(clean_code.split())  # 这里去不去空格有待商榷。要去掉
        ...
        # path_dict[file] = seq_embeds, cfg_allpath
